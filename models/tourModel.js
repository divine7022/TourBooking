...
// DOCUMENT MIDDLEWARE: runs before .save() and .create() // it execute before Creating a new document with "POST" req.
...
tourSchema.pre(/^find/, function(next) {
  //"/^find/" regulare expersion to find any query that starts with find,findOne, etc..
  this.find({ secretTour: { $ne: true } }); // make sures that our secrettour should should not visible anywhere except in the mongoee compouse
